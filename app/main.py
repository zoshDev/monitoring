...
from app.core.logging_config import setup_logging, get_formatted_message
import logging
...
async def startup_event():
    logger.info(get_formatted_message('START', "Démarrage de l'application"))
    start_scheduler()  # Démarre le scheduler qui lancera automatiquement le nouveau scanner
    logger.info("Application prête.")

@app.on_event("shutdown")
async def shutdown_event():
    logger.info(get_formatted_message('END', "Arrêt de l'application"))
